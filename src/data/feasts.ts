...
export const fixedFeasts: Feast[] = [
  ...
  { month: 4, day: 14, name: "San Anselmo, Obispo, Confesor y Doctor", rank: "menor", color: "rojo", propers: { gloria: true, creed: true, preface: "Pascua" }, },
  ...
  { month: 12, day: 13, name: "Santa Lucía, Virgen y Mártir", rank: "conmemoración", color: "rosa", },
