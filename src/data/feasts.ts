...
export const fixedFeasts: Feast[] = [
  ...
  { month: 1, day: 19, name: "Otorgamiento del Episcopado Católico Anglicano (1978)", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 2, day: 10, name: "Santa Escolástica, Virgen", rank: "menor", color: "rojo", propers: { gloria: true }, },
  { month: 2, day: 11, name: "Nuevos Mártires de Rusia", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 2, day: 16, name: "San Pedro Damián, Obispo, Confesor y Doctor", rank: "menor", color: "morado", propers: { gloria: true, creed: true, preface: "Cuaresma" }, },
  { month: 2, day: 17, name: "San Matías, Apóstol y Mártir", rank: "mayor", color: "rojo", propers: { gloria: true, creed: true, preface: "Apóstoles" }, hasPropers: true, transferable: true, },
  ...
  { month: 3, day: 16, name: "San Patricio, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Cuaresma" }, },
  { month: 3, day: 17, name: "San Cirilo de Jerusalén, Obispo, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "Cuaresma" }, },
  { month: 3, day: 18, name: "San José, Esposo de la B.V.M.", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "San José" }, },
  { month: 3, day: 19, name: "San Cutberto, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Cuaresma" }, },
  { month: 3, day: 19, name: "Beato Thomas Ken, Obispo y Confesor", rank: "menor", color: "blanco", optional: true, },
  { month: 3, day: 20, name: "San Benito, Abad", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Cuaresma" }, },
  ...
  // ===== Abril =====
  { month: 4, day: 6, name: "San Justino, Mártir", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  { month: 4, day: 9, name: "Beato William Law, Presbítero y Confesor", rank: "menor", color: "blanco", optional: true, },
  { month: 4, day: 11, name: "San Stephen Harding, Abad", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  { month: 4, day: 11, name: "Beato George Augustus Selwyn, Obispo y Confesor", rank: "menor", color: "blanco", optional: true, },
  { month: 4, day: 12, name: "San Alphege, Obispo y Mártir", rank: "conmemoración", color: "blanco", },
  { month: 4, day: 14, name: "San Anselmo, Obispo, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "Pascua" }, },
  { month: 4, day: 15, name: "Patrocinio de San José", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "San José" }, },
  { month: 4, day: 16, name: "San Jorge, Mártir", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  { month: 4, day: 18, name: "San Marcos, Evangelista", rank: "mayor", color: "rojo", propers: { gloria: true, creed: true, preface: "Apóstoles" }, hasPropers: true, transferable: true, },
  { month: 4, day: 20, name: "San Pedro Canisio, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "Pascua" }, },
  { month: 4, day: 21, name: "San Pablo de la Cruz, Confesor", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  { month: 4, day: 22, name: "San Pedro Mártir", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  { month: 4, day: 23, name: "Santa Catalina de Siena, Virgen y Doctora", rank: "menor", color: "rojo", propers: { gloria: true, creed: true, preface: "Pascua" }, },
  ...
  { month: 5, day: 12, name: "San Dunstano, Obispo y Confesor", rank: "menor", color: "morado", propers: { gloria: true, creed: true, preface: "Ascensión" }, },
  { month: 5, day: 13, name: "San Bernardino de Siena, Confesor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "Ascensión" }, },
  ...
  { month: 7, day: 6, name: "San Silas, Mártir", rank: "menor", color: "verde", propers: { gloria: true }, },
  ...
  { month: 8, day: 4, name: "San Nicodemo, Confesor", rank: "conmemoración", color: "verde", },
  ...
  { month: 8, day: 11, name: "Santa Clara, Virgen", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 9, day: 6, name: "San Evurcio, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 9, day: 18, name: "San Teodoro, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
