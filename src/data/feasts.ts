...
export const fixedFeasts: Feast[] = [
  ...
  { month: 2, day: 4, name: "San Andrés de Corsini, Obispo y Confesor", rank: "conmemoración", color: "blanco", },
  ...
  { month: 2, day: 22, name: "San José de Arimatea, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 3, day: 8, name: "San Juan de Mata, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 3, day: 8, name: "San Juan de Dios, Confesor", rank: "conmemoración", color: "blanco", },
  ...
  { month: 3, day: 22, name: "La Compasión de la B.V.M.", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "B.V.M." }, },
  { month: 3, day: 22, name: "Beato James de Kove, Confesor", rank: "conmemoración", color: "blanco", },
  { month: 3, day: 27, name: "San Juan de Damasco, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  // ===== Abril =====
  { month: 4, day: 4, name: "San Isidoro de Sevilla, Obispo, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 4, day: 29, name: "San Pedro de Verona, Mártir", rank: "menor", color: "rojo", propers: { gloria: true, preface: "Pascua" }, },
  ...
  { month: 5, day: 26, name: "San Agustín de Inglaterra, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 5, day: 27, name: "San Beda el Venerable, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  { month: 5, day: 28, name: "San Felipe Neri, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  // ===== Junio =====
  ...
  { month: 6, day: 10, name: "Santa Margarita de Escocia, Reina y Viuda", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 6, day: 28, name: "San Ireneo, Obispo y Mártir", rank: "menor", color: "rojo", propers: { gloria: true }, },
  ...
  { month: 7, day: 5, name: "San Vladimiro, Rey y Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 7, day: 5, name: "San Antonio María Zacaría, Confesor", rank: "conmemoración", color: "blanco", },
  ...
  { month: 7, day: 12, name: "San Juan Gualberto, Abad", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 7, day: 18, name: "San Camilo de Lelis, Confesor", rank: "conmemoración", color: "blanco", },
  { month: 7, day: 19, name: "San Vicente de Paúl, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 7, day: 20, name: "Santa Margarita de Antioquía, Virgen y Mártir", rank: "menor", color: "rojo", propers: { gloria: true }, },
  { month: 7, day: 20, name: "San Jerónimo Emiliano, Confesor", rank: "conmemoración", color: "blanco", },
  ...
  { month: 7, day: 26, name: "Santa Ana, Madre de la B.V.M.", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 8, day: 2, name: "San Alfonso María de Ligorio, Obispo, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  { month: 8, day: 4, name: "Santo Domingo, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 8, day: 3, name: "San Nicodemo, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 8, day: 9, name: "San Juan María Vianney (Cura de Ars), Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 8, day: 16, name: "San Joaquín, Padre de la B.V.M.", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 8, day: 30, name: "Santa Rosa de Lima, Virgen", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 9, day: 24, name: "Nuestra Señora de las Mercedes", rank: "conmemoración", color: "blanco", },
  ...
  { month: 9, day: 27, name: "Santos Cosme y Damián, Mártires", rank: "menor", color: "rojo", propers: { gloria: true }, },
  ...
  { month: 10, day: 4, name: "San Francisco de Asís, Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 10, day: 6, name: "Santa Fe de Agen, Virgen y Mártir", rank: "conmemoración", color: "rojo", },
  ...
  { month: 10, day: 10, name: "San Francisco de Borja, Confesor", rank: "conmemoración", color: "blanco", },
  { month: 10, day: 11, name: "La Maternidad de la B.V.M.", rank: "menor", color: "blanco", propers: { gloria: true, creed: true, preface: "B.V.M." }, },
  ...
  { month: 10, day: 15, name: "Santa Teresa de Jesús, Virgen y Doctora", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 10, day: 25, name: "Santos Crispín y Crispiniano, Mártires", rank: "menor", color: "rojo", propers: { gloria: true }, },
  ...
  { month: 11, day: 6, name: "San Leonardo, Abad", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 11, day: 7, name: "San Wilibrordo, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  { month: 11, day: 8, name: "Todos los Mártires y Santos Anglicanos", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 11, day: 15, name: "San Alberto Magno, Obispo, Confesor y Doctor", rank: "menor", color: "blanco", propers: { gloria: true, creed: true }, },
  ...
  { month: 11, day: 22, name: "Santa Cecilia, Virgen y Mártir", rank: "menor", color: "rojo", propers: { gloria: true }, },
  ...
  { month: 11, day: 26, name: "San Silvestre, Abad", rank: "menor", color: "blanco", propers: { gloria: true }, },
  { month: 11, day: 28, name: "Santa Catalina Labouré, Virgen", rank: "menor", color: "blanco", propers: { gloria: true }, },
  ...
  { month: 12, day: 6, name: "San Nicolás, Obispo y Confesor", rank: "menor", color: "blanco", propers: { gloria: true }, },
