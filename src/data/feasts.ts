...
export const fixedFeasts: Feast[] = [
  ...
  { month: 2, day: 21, name: "San Pedro Damián, Obispo, Confesor y Doctor", rank: "menor", color: "morado", propers: { gloria: true, creed: true, preface: "Cuaresma" }, },
  ...
  { month: 4, day: 14, name: "San Justino, Mártir", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  ...
  { month: 4, day: 23, name: "San Jorge, Mártir", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  ...
  { month: 4, day: 29, name: "San Pedro Mártir", rank: "menor", color: "blanco", propers: { gloria: true, preface: "Pascua" }, },
  { month: 4, day: 30, name: "Santa Catalina de Siena, Virgen y Doctora", rank: "menor", color: "rojo", propers: { gloria: true, creed: true, preface: "Pascua" }, },
  // ===== Mayo =====
  ...
  { month: 7, day: 13, name: "San Silas, Mártir", rank: "menor", color: "verde", propers: { gloria: true }, },
  ...
  { month: 8, day: 3, name: "San Nicodemo, Confesor", rank: "conmemoración", color: "verde", },
